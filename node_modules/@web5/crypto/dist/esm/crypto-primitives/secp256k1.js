...
export class Secp256k1 {
    ...
    static bytesToPrivateKey(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const points = yield Secp256k1.getCurvePoints({ key: privateKeyBytes });
    ...
    static bytesToPublicKey(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const points = yield Secp256k1.getCurvePoints({ key: publicKeyBytes });
     ...
     */
    static compressPublicKey(options) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    static decompressPublicKey(options) {
        return __awaiter(this, void 0, void 0, function* () {
            let { publicKeyBytes } = options;
            // Decode Weierstrass points from the public key byte array.
            const point = secp256k1.ProjectivePoint.fromHex(publicKeyBytes);
