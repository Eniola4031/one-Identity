...
export class Ed25519 {
     ...
     */
    static bytesToPrivateKey(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            privateKey.kid = yield Jose.jwkThumbprint({ key: privateKey });
            return privateKey;
        });
    }
    /**
     ...
     */
    static bytesToPublicKey(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // Compute the JWK thumbprint and set as the key ID.
            publicKey.kid = yield Jose.jwkThumbprint({ key: publicKey });
            return publicKey;
        });
    }
    /**
    ...
    static convertPrivateKeyToX25519(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // Compute the JWK thumbprint and set as the key ID.
            x25519PrivateKey.kid = yield Jose.jwkThumbprint({ key: x25519PrivateKey });
    ...
    static convertPublicKeyToX25519(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const isValid = yield Ed25519.validatePublicKey({ key: ed25519PublicKeyBytes });
            if (!isValid) {
            ...
            // Compute the JWK thumbprint and set as the key ID.
            x25519PublicKey.kid = yield Jose.jwkThumbprint({ key: x25519PublicKey });
     ...
     */
    static computePublicKey(options) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    static privateKeyToBytes(options) {
        return __awaiter(this, void 0, void 0, function* () {
            const { privateKey } = options;
     ...
     */
    static publicKeyToBytes(options) {
        return __awaiter(this, void 0, void 0, function* () {
            const { publicKey } = options;
