...
var ConcatKdf = /** @class */ (function () {
     ...
     */
    ConcatKdf.deriveKey = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var keyDataLen, sharedSecret, hashLen, roundCount, counter, otherInfo, derivedKeyingMaterial;
            return __generator(this, function (_a) {
                keyDataLen = options.keyDataLen, sharedSecret = options.sharedSecret;
                hashLen = 256;
                ...
                derivedKeyingMaterial = (0, sha256_1.sha256)((0, utils_1.concatBytes)(counter, sharedSecret, otherInfo));
    ...
    * @returns OtherInfo as a Uint8Array.
     */
    ConcatKdf.computeOtherInfo = function (options) {
        // Required sub-fields.
        var algorithmId = ConcatKdf.toDataLenData({ data: options.algorithmId });
        var partyUInfo = ConcatKdf.toDataLenData({ data: options.partyUInfo });
        var partyVInfo = ConcatKdf.toDataLenData({ data: options.partyVInfo });
        // Optional sub-fields.
        var suppPubInfo = ConcatKdf.toDataLenData({ data: options.suppPubInfo, variableLength: false });
        var suppPrivInfo = ConcatKdf.toDataLenData({ data: options.suppPrivInfo });
     ...
     */
    ConcatKdf.toDataLenData = function (options) {
        var data = options.data, _a = options.variableLength, variableLength = _a === void 0 ? true : _a;
        var encodedData;
