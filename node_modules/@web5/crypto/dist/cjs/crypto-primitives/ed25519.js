...
var Ed25519 = /** @class */ (function () {
     ...
     */
    Ed25519.bytesToPrivateKey = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var privateKeyBytes, publicKeyBytes, privateKey, _a;
     ...
     */
    Ed25519.bytesToPublicKey = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var publicKeyBytes, publicKey, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    Ed25519.convertPrivateKeyToX25519 = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var privateKey, ed25519PrivateKeyBytes, x25519PrivateKeyBytes, x25519PublicKeyBytes, x25519PrivateKey, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        privateKey = options.privateKey;
                        return [4 /*yield*/, Ed25519.privateKeyToBytes({ privateKey: privateKey })];
                    case 1:
                        ed25519PrivateKeyBytes = _b.sent();
                        ...
                        // Compute the JWK thumbprint and set as the key ID.
                        _a = x25519PrivateKey;
                        return [4 /*yield*/, jose_js_1.Jose.jwkThumbprint({ key: x25519PrivateKey })];
                    case 2:
                        // Compute the JWK thumbprint and set as the key ID.
                        _a.kid = _b.sent();
    ...
    Ed25519.convertPublicKeyToX25519 = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var publicKey, ed25519PublicKeyBytes, isValid, x25519PublicKeyBytes, x25519PublicKey, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        publicKey = options.publicKey;
                        return [4 /*yield*/, Ed25519.publicKeyToBytes({ publicKey: publicKey })];
                    case 1:
                        ed25519PublicKeyBytes = _b.sent();
                        return [4 /*yield*/, Ed25519.validatePublicKey({ key: ed25519PublicKeyBytes })];
                    case 2:
                        isValid = _b.sent();
                        if (!isValid) {
                        ...
                        // Compute the JWK thumbprint and set as the key ID.
                        _a = x25519PublicKey;
                        return [4 /*yield*/, jose_js_1.Jose.jwkThumbprint({ key: x25519PublicKey })];
                    case 3:
                        // Compute the JWK thumbprint and set as the key ID.
                        _a.kid = _b.sent();
     ...
     */
    Ed25519.computePublicKey = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var privateKey, privateKeyBytes, publicKeyBytes, publicKey, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        privateKey = options.privateKey;
     ...
     */
    Ed25519.publicKeyToBytes = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var publicKey, publicKeyBytes;
            return __generator(this, function (_a) {
                publicKey = options.publicKey;
                // Verify the provided JWK represents a valid OKP public key.
                if (!jose_js_1.Jose.isOkpPublicKeyJwk(publicKey)) {
    ...
    Ed25519.sign = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var key, data, privateKeyBytes, signature;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        key = options.key, data = options.data;
                        return [4 /*yield*/, Ed25519.privateKeyToBytes({ privateKey: key })];
                    case 1:
    ...
    Ed25519.verify = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var key, signature, data, publicKeyBytes, isValid;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        key = options.key, signature = options.signature, data = options.data;
                        return [4 /*yield*/, Ed25519.publicKeyToBytes({ publicKey: key })];
                    case 1:
