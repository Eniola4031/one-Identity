...
var EcdhAlgorithm = /** @class */ (function (_super) {
    __extends(EcdhAlgorithm, _super);
    function EcdhAlgorithm() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.names = ['ECDH'];
        _this.curves = ['secp256k1', 'X25519'];
        return _this;
    }
    EcdhAlgorithm.prototype.deriveBits = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var algorithm, baseKey, length, sharedSecret, curve, _a, lengthInBytes;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        algorithm = options.algorithm, baseKey = options.baseKey, length = options.length;
                        // Validate the input parameters.
                        this.checkDeriveBitsOptions({ algorithm: algorithm, baseKey: baseKey });
                        curve = baseKey.crv;
                        _a = curve;
                        switch (_a) {
                            case 'secp256k1': return [3 /*break*/, 1];
                            case 'X25519': return [3 /*break*/, 3];
                        }
                        return [3 /*break*/, 5];
                    case 1: return [4 /*yield*/, index_js_1.Secp256k1.sharedSecret({
                            privateKeyA: baseKey,
                    ...
                    case 2:
                        ...
                        return [3 /*break*/, 6];
                    case 3: return [4 /*yield*/, index_js_1.X25519.sharedSecret({
                            privateKeyA: baseKey,
                            publicKeyB: algorithm.publicKey
                        })];
                    case 4:
                    ...
                    case 5:
                        {
                            throw new TypeError("Out of range: '".concat(curve, "'. Must be one of '").concat(this.curves.join(', '), "'"));
                        }
                        _b.label = 6;
                    case 6:
                        ...
                        return [2 /*return*/, lengthInBytes === sharedSecret.byteLength ?
                                sharedSecret :
    ...
    EcdhAlgorithm.prototype.generateKey = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var algorithm, keyOperations, privateKey, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        algorithm = options.algorithm, keyOperations = options.keyOperations;
                        // Validate the input parameters.
                        this.checkGenerateKeyOptions({ algorithm: algorithm, keyOperations: keyOperations });
                        _a = algorithm.curve;
                        switch (_a) {
                            case 'secp256k1': return [3 /*break*/, 1];
                            case 'X25519': return [3 /*break*/, 3];
                        ...
                        return [3 /*break*/, 5];
                    case 1: return [4 /*yield*/, index_js_1.Secp256k1.generateKey()];
                    case 2:
                        privateKey = _b.sent();
                        return [3 /*break*/, 5];
                    case 3: return [4 /*yield*/, index_js_1.X25519.generateKey()];
                    case 4:
                        privateKey = _b.sent();
                        return [3 /*break*/, 5];
                    case 5:
