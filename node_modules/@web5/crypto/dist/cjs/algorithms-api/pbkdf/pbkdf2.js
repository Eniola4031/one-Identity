...
var BasePbkdf2Algorithm = /** @class */ (function (_super) {
    ...
    BasePbkdf2Algorithm.prototype.decrypt = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                throw new errors_js_1.InvalidAccessError("Requested operation 'decrypt' is not valid for '".concat(this.names.join(', '), "' keys."));
            });
        });
    };
    BasePbkdf2Algorithm.prototype.encrypt = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                throw new errors_js_1.InvalidAccessError("Requested operation 'encrypt' is not valid for '".concat(this.names.join(', '), "' keys."));
            });
        });
    };
    BasePbkdf2Algorithm.prototype.generateKey = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                throw new errors_js_1.InvalidAccessError("Requested operation 'generateKey' is not valid for '".concat(this.names.join(', '), "' keys."));
            });
        });
    };
    BasePbkdf2Algorithm.prototype.sign = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                throw new errors_js_1.InvalidAccessError("Requested operation 'sign' is not valid for '".concat(this.names.join(', '), "' keys."));
            });
        });
    };
    BasePbkdf2Algorithm.prototype.verify = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                throw new errors_js_1.InvalidAccessError("Requested operation 'verify' is not valid for '".concat(this.names.join(', '), "' keys."));
            });
        });
    };
